...
<div class="card mt-3">
    <div class="card-body">
        ...
        <form action="<?=site_url('/save_company')?>" method="post" enctype="multipart/form-data">
            ...
            <input type="text" name="description" id="description" class="form-control" placeholder=""  value="<?=old('description')?>">
            </div>

            <div class="mb-3">
            <label for="representative" class="form-label">Titular</label>
            <input type="text" name="representative" id="representative" class="form-control" placeholder="" value="<?=old('representative')?>">
            </div>
